...
const About = () => {
  return (
    ...
    >
     I am an experienced full-stack web developer with expertise in MEVN stack, 
     Tailwind CSS, and Bootstrap. Additionally, I have a strong background in 
     video editing using Adobe Premiere Pro and After Effects. With my skills 
     in web development and video editing, I bring creativity and professionalism 
